...
var cnItems = {
    ...
    "Higher levels increase Energy recovery rate and Max Energy. During surfing, increases wave catch probability and decreases wave waiting time.": "等级越高，能量恢复速度和最大能量增加。冲浪时，增加抓浪概率，减少等待浪的时间。",
...
var cnRegReplace = new Map([
    ...
    [/^GOAT(.+)Surfer$/, '山羊冲浪手'],
    [/^Need 2.14 more energy$/, '还需要 $1 能量'],
