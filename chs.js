...
var cnItems = {
    ...
    "Enzo wants his own board but lacks the money. He starts working at a local café as a Dishwasher, slowly saving for his first surfboard. Marco continues to support him as he practices in his free time, slowly improving his paddling and balance.": "恩佐想拥有自己的冲浪板，但缺钱。他开始在当地一家咖啡馆做洗碗工，慢慢攒钱买他的第一块冲浪板。当他在空闲时间练习时，马可继续支持他，慢慢地提高他的划水和平衡。",
    "Skills 🏆": "技能 🏆",
    "Skill": "技能",
    "skill": "技能",
    "Level": "等级",
    ...
    "Final Results": "最终结果",
    "Finals": "决赛",
    "- You're favored to win": "- 你被看好会赢",
    "- Even match": "- 均匀匹配",
    "- Tough competition": "- 竞争激烈",
    "/hour": "/小时",
    ", Heat": ", 预赛",
    "• 1st Place: 60% of prize pool": "• 第1名：奖金池的60%",
    "• 2nd Place: 30% of prize pool": "• 第2名：奖金池的50%",
    "• 3rd Place: 2x 10% of prize pool": "• 第3名：奖金池的10%的2倍",
    "• Each heat requires you to surf against other competitors": "• 每一场预赛都要求你与其他选手进行冲浪比赛",
    "• In numbered rounds, top 2 surfers out of 4 advance to the next round, 3rd and 4th are eliminated": "• 在分组比赛中，4名选手中的前2名进入下一轮，第3名和第4名被淘汰",
    "• In quarterfinals and later, only 1 surfer out of 2 advances to next round": "• 在四分之一决赛及之后的比赛中，2名冲浪者中只有1名进入下一轮",
    "❌ Eliminated": "❌ 淘汰",
    "⭐ Competitor Rating vs Your Rating. Color coding shows your chances:": "⭐ 竞争对手评分vs你的评分。用颜色表示你的机会：",
    "🌊 After enrolling, you'll compete in multiple heats:": "🌊 报名后，您将参加多个预赛：",
    "🏄‍♂️ Heat Victory": "🏄‍♂️ 预赛胜利",
    "🏆 Competitions": "🏆 比赛",
    "🏆 Prize distribution for each competition:": "🏆 每场比赛的奖品分配：",
    "💰 Entry fee varies by competition level. Higher entry fees usually mean bigger prize pools and tougher competition!": "💰 参赛费用因比赛级别而异。更高的报名费通常意味着更大的奖金池和更激烈的竞争！",
    "📊 After the competition ends, you can view the complete leaderboard with prizes and positions": "📊 比赛结束后，可查看包含奖品和名次的完整排行榜",
    "Improve forecasting and observing skills.": "提高预测和观察能力。",
    "Living in your car. Not comfortable but very cheap.": "住在你的车里。不舒服，但是很便宜。",
    "Mediterranean Beginner Comp": "地中海初学者比赛",
    "Mediterranean Intermediate Comp": "地中海中级比赛",
    "Hourly fee when equipped:": "装备后每小时收费：",
    "Home Workout Gear": "家庭健身器材",
    "Need to equip a surfboard": "需要装备一个冲浪板",
    "Orange": "橙色",
    "Pig Helpless": "无助的猪",
    "Active Automations:": "活跃的自动化:",
    "Start Autoplay": "开始自动播放",
    "Competitions": "比赛",
    "Disable Rest Automation": "禁用休息自动化",
    "Disable Work Automation": "禁用工作自动化",
    "View Measurements": "查看测量",
    "Entrepreneur Path": "企业家之路",
    "(anonymous user)": "(匿名用户)",
    "/ Load Game": "/ 加载游戏",
    "Activate Full Game": "激活完整游戏",
    "Automations": "自动化",
    "Cloud Load": "云加载",
    "Import / Export Game": "导入 / 导出存档",
    "Local Load": "本地加载",
    "Local Save": "本地保存",
    "Log In": "登录（仅英文版才可以）",
    "Purchase surfboard_shaping_brand": "购买 冲浪板塑造品牌",
    "rest": "休息",
    "work": "工作",
    "Start and manage your own surf-related businesses.": "开始并管理你自己的冲浪相关业务。",
    "Work 1 hours as Pro Surfboard Designer": "作为职业冲浪板设计师工作1小时",
    "Email": "邮箱",
    "Link Your Account": "链接您的帐户",
    "Link your account to save your progress across devices": "链接您的帐户以跨设备保存您的进度",
    "Or continue with": "或者继续通过",
    "Send Magic Link": "发送魔法链接",
    "Game saved successfully!": "游戏保存成功！",
    "Boost fitness and speed generation.": "提高体能和速度生成。",
    "Housing": "住房",
    "Improve fitness.": "提高体能。",
    "Old Car": "旧车",
    "Small Local Gym": "当地小型健身房",
    "Surf Forecasting App": "冲浪预测应用程序",
    "🏆 Each surfing session earns skill points which improve your skill levels. Critical maneuvers earn extra points and 👏 Respect. Critical probability is": "🏆每次冲浪都会获得技能点，提高你的技能水平。关键的操作可以获得额外的分数和👏天赋。临界概率为",
    "Automation": "自动化",
    "Best Round Reached:": "达到的最佳回合：",
    "Blessing of the mediterranean breeze": "地中海微风的祝福",
    "Broke in biarritz": "闯入比亚里茨",
    "Entries": "条目",
    "Finals:": "决赛:",
    ...
    "Rivalry at la gravière": "la gravitre的竞争",
    "Semifinals:": "半决赛:",
    "Spirit of the atlantic swell": "大西洋涌动的精神",
    "The challenge of hossegor": "胡赛高的挑战",
    "The first taste of saltwater": "第一次尝到咸水",
    "Total points from all performed skills": "所有技能的总得分",
    "Total Prize Money": "总奖金",
    "Victories": "胜利",
    "All Heats": "所有预赛",
    "Close Results": "关闭结果",
    "Competition History": "比赛历史",
    "Won": "赢得",
    "You": "你",
    "Eliminated in": "淘汰于",
    "Semifinals": "半决赛",
...
var cnRegReplace = new Map([
    ...
    [/^GOAT(.+)Surfer$/, '史上最佳冲浪手'],
    [/^Need (.+) more energy$/, '还需要 $1 精力'],
    [/^Working as Surf School Assistant \((.+)\/hour\)$/, '担任冲浪学校助理（$1/小时）'],
    ...
    [/^([\d\.]+)e([\d\.,]+) elves$/, '$1e$2 精灵'],
    [/^([\d\.,]+)y ([\d\.,]+)d$/, '$1 年 $2 天'],
    [/^([\d\.,]+)y ([\d\.,]+)d ([\d\.,]+)m$/, '$1 年 $2 天 $3 分'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)d$/, '$1 年 $2 月 $3 天'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)h$/, '$1 年 $2 月 $3 小时'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)m$/, '$1 年 $2 月 $3 分'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)h ([\d\.,]+)m$/, '$1 年 $2 月 $3 小时 $4 分'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)d ([\d\.,]+)m$/, '$1 年 $2 月 $3 天 $4 分'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)d ([\d\.,]+)h$/, '$1 年 $2 月 $3 天 $4 小时'],
    [/^([\d\.,]+)d ([\d\.,]+)h$/, '$1 天 $2 小时'],
    [/^([\d\.,]+)m ([\d\.,]+)d ([\d\.,]+)h$/, '$1 月 $2 天 $3 小时'],
    [/^([\d\.,]+)m ([\d\.,]+)d ([\d\.,]+)h ([\d\.,]+)m$/, '$1 月 $2 天 $3 小时 $4 分'],
    [/^([\d\.,]+)y ([\d\.,]+)m ([\d\.,]+)d ([\d\.,]+)h ([\d\.,]+)m$/, '$1 年 $2 月 $3 天 $4 小时 $5 分'],
    [/^([\d\.,]+) seconds$/, '$1 秒'],
    [/^([\d\.,]+) minutes$/, '$1 分钟'],
    [/^([\d\.,]+) minutes ago$/, '$1 分钟前'],
    [/^([\d\.,]+) elves$/, '$1 精灵'],
    ...
    [/^Round ([\d\.,]+):$/, '回合 $1:'],
    [/^Round ([\d\.,]+)$/, '回合 $1'],
    [/^Reach Wave Reading level ([\d\.,]+)$/, '达到波浪阅读等级 $1'],
    [/^Day ([\d\.,]+)$/, '天数 $1'],
    [/^level ([\d\.,]+) \/ ([\d\.,]+)$/, '等级 $1 \/ $2'],
    [/^level: ([\d\.,]+) \/ ([\d\.,]+)$/, '等级 $1 \/ $2'],
